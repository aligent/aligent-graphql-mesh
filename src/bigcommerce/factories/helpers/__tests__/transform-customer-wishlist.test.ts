...
const bcWishListNoItemEdges: BC_WishlistConnection = {
    edges: [
        {
...
const bcWishList: BC_WishlistConnection = {
    edges: [
        {
            cursor: 'YXJyYXljb25uZWN0aW9uOjA=',
            node: {
...
const bcWishListItems: BC_WishlistItemConnection = {
    edges: [
        {
            cursor: 'YXJyYXljb25uZWN0aW9uOjA=',
            node: {
