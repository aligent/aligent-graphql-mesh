import { BcProduct, Category } from '../../types';
...
export const createAcReadyProduct = (bcProduct: BcProduct) => {
...
export const createAcReadyCategory = (category: Category) => {
    return {
        id: category.entityId,
        description: category.description,
        name: category.name,
        meta_description: category.seo.metaDescription,
        meta_title: category.seo.pageTitle,
        meta_keywords: category.seo.metaKeywords,
        product_count: category.products.collectionInfo.totalItems,
    };
};
