...
export const getTransformedVariants = (oroProductData: OroProduct): Array<ConfigurableVariant> => {
    const variantsResults: ConfigurableVariant[] = oroProductData.included
        ?.map((entity) => {
