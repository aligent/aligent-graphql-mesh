...
export const customerResolver = {
    resolve: async (_root, _args, context, _info) => {
        ...
        const allowRemoteShoppingAssistance = customerAttributesFromFormFields.allow_remote_shopping_assistance[0];
        const allowRemoteAssist = {
            allow_remote_shopping_assistance: allowRemoteShoppingAssistance === 'Yes' ? true : false
        }
