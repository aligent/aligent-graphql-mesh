...
/** A blog index page. */
export type BlogIndexPage = WebPage & {
...
export type Query = {
  ...
  node?: Maybe<Banner | Blog | BlogPost | Brand | Cart | Category | Checkout | ContactPage | NormalPage | Product | RawHtmlPage | Redirect | Variant>;
  /** A site */
  site: Site;
};
