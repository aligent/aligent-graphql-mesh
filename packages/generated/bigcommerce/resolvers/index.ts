...
export type BundleProduct = CustomizableProductInterface & PhysicalProductInterface & ProductInterface & RoutableInterface & {
  ...
  /** @deprecated Use the `custom_attributes` field instead. */
  marketplacer_brand?: Maybe<Scalars['Int']['output']>;
  /** @deprecated Use the `custom_attributes` field instead. */
  marketplacer_seller?: Maybe<Scalars['Int']['output']>;
  /** @deprecated Use the `custom_attributes` field instead. */
...
export type ByLocation = {
  ...
  /** Location code. */
  locationEntityCode?: Maybe<Scalars['String']['output']>;
  /** Location id. */
  locationEntityId?: Maybe<Scalars['Int']['output']>;
  /** Location type id. */
  locationEntityTypeId?: Maybe<Scalars['String']['output']>;
  /** Indicates a threshold low-stock level. */
  warningLevel?: Maybe<Scalars['Int']['output']>;
};
...
export type Customer = {
  ...
  allow_remote_shopping_assistance?: Maybe<Scalars['Boolean']['output']>;
  /** The contents of the customer's compare list. */
  compare_list?: Maybe<CompareList>;
...
export type DeliveryInstructions = {
  ...
  authorityToLeave?: Maybe<Scalars['Boolean']['output']>;
...
export type FreeShippingDetails = {
  ...
  free_shipping_active?: Maybe<Scalars['Boolean']['output']>;
  ...
  free_shipping_percentage?: Maybe<Scalars['Float']['output']>;
...
export type Mutation = {
   ...
   */
  postContactForm?: Maybe<Scalars['Boolean']['output']>;
...
export type PaypalExpressClientConfig = {
  ...
  is_guest_checkout_allowed?: Maybe<Scalars['Boolean']['output']>;
  is_visible_on_product_page?: Maybe<Scalars['Boolean']['output']>;
...
export type PaypalExpressConfig = {
  ...
  billing_agreement_code?: Maybe<Scalars['String']['output']>;
  in_context_config?: Maybe<PaypalExpressInContextConfig>;
  is_context_checkout?: Maybe<Scalars['Boolean']['output']>;
  paylater_enabled?: Maybe<Scalars['Boolean']['output']>;
  payment_acceptance_mark_href?: Maybe<Scalars['String']['output']>;
  payment_acceptance_mark_src?: Maybe<Scalars['String']['output']>;
  redirect_url?: Maybe<Scalars['String']['output']>;
  sdk_url?: Maybe<Scalars['String']['output']>;
};
...
export type PaypalExpressInContextConfig = {
  ...
  in_context_id?: Maybe<Scalars['String']['output']>;
  merchant_id?: Maybe<Scalars['String']['output']>;
};
...
export type RedirectUrls = {
  ...
  cart_url: Scalars['String']['output'];
  checkout_url: Scalars['String']['output'];
  embedded_checkout_url: Scalars['String']['output'];
};
...
export type ShippingAddressInput = {
  ...
  address?: InputMaybe<CartAddressInput>;
  authorityToLeave?: InputMaybe<Scalars['Boolean']['input']>;
...
export type SimpleProduct = CustomizableProductInterface & PhysicalProductInterface & ProductInterface & RoutableInterface & {
  ...
  by_location?: Maybe<Array<Maybe<ByLocation>>>;
  /** The relative canonical URL. This value is returned only if the system setting 'Use Canonical Link Meta Tag For Products' is enabled. */
  canonical_url?: Maybe<Scalars['String']['output']>;
  /** The categories assigned to a product. */
  categories?: Maybe<Array<Maybe<CategoryInterface>>>;
...
export type StoreConfig = {
  ...
  /** Afterpay Enabled */
  afterpaypay_active?: Maybe<Scalars['String']['output']>;
  /** Afterpay Display on Cart Page */
  afterpaypay_api_enable_cta_cart_page?: Maybe<Scalars['String']['output']>;
  /** Afterpay Display on Mini Cart */
  afterpaypay_api_enable_cta_mini_cart?: Maybe<Scalars['String']['output']>;
  /** Afterpay Display on Product Page */
  afterpaypay_api_enable_cta_product_page?: Maybe<Scalars['String']['output']>;
  /** Afterpay Maximum Order Total */
  afterpaypay_api_max_order_total?: Maybe<Scalars['String']['output']>;
  /** Afterpay Minimum Order Total */
  afterpaypay_api_min_order_total?: Maybe<Scalars['String']['output']>;
  /** Afterpay API Mode */
  afterpaypay_api_mode?: Maybe<Scalars['String']['output']>;
  /** Afterpay Title */
  afterpaypay_title?: Maybe<Scalars['String']['output']>;
  ...
  captcha_public_key_v2_checkbox?: Maybe<Scalars['String']['output']>;
  /** Google API website key for reCAPTCHA v2 - Invisible */
  captcha_public_key_v2_invisible?: Maybe<Scalars['String']['output']>;
  /** Google API website key for reCAPTCHA v3 */
  captcha_public_key_v3_invisible?: Maybe<Scalars['String']['output']>;
  /** reCAPTCHA type for Contact Us form */
  captcha_type_contact?: Maybe<Scalars['String']['output']>;
  /** reCAPTCHA type for Customer Create form */
  captcha_type_customer_create?: Maybe<Scalars['String']['output']>;
  /** reCAPTCHA type for Customer Edit form */
  captcha_type_customer_edit?: Maybe<Scalars['String']['output']>;
  /** reCAPTCHA type for Forgot Password form */
  captcha_type_customer_forgot_password?: Maybe<Scalars['String']['output']>;
  /** reCAPTCHA type for Customer Login form */
  captcha_type_customer_login?: Maybe<Scalars['String']['output']>;
  /** reCAPTCHA type for Newsletter form */
  captcha_type_newsletter?: Maybe<Scalars['String']['output']>;
  /** reCAPTCHA type for place order form */
  captcha_type_place_order?: Maybe<Scalars['String']['output']>;
  /** reCAPTCHA type for Product Review form */
  captcha_type_product_review?: Maybe<Scalars['String']['output']>;
  /** reCAPTCHA type for Send Friend form */
  captcha_type_sendfriend?: Maybe<Scalars['String']['output']>;
  /** reCAPTCHA type for wishlist share */
  captcha_type_wishlist_sharing?: Maybe<Scalars['String']['output']>;
  ...
  plpAddToCartEnabled?: Maybe<Scalars['Boolean']['output']>;
  /** Indicates if quantity modifier is enabled for PLP */
  plpQtyModifierEnabled?: Maybe<Scalars['Boolean']['output']>;
  ...
  pwa_base_url: Scalars['String']['output'];
...
export type StoreInformation = {
  ...
  /** Merchant VAT number */
  merchant_vat_number?: Maybe<Scalars['String']['output']>;
  /** Store Name */
  name?: Maybe<Scalars['String']['output']>;
  /** Store Phone number */
  phone?: Maybe<Scalars['String']['output']>;
  ...
  street_line1?: Maybe<Scalars['String']['output']>;
  /** Street Address Line 2 */
  street_line2?: Maybe<Scalars['String']['output']>;
};
...
export type WishlistInput = {
  ...
  email_address?: InputMaybe<Array<InputMaybe<Scalars['String']['input']>>>;
  /** Customer's message */
  message?: InputMaybe<Scalars['String']['input']>;
  /** Wishlist sharing code */
  sharing_code: Scalars['String']['input'];
  /** Wishlist ID */
  wishlist_id: Scalars['Int']['input'];
};
...
export type ResolversInterfaceTypes<RefType extends Record<string, unknown>> = {
  ...
  AttributeOptionsInterface: ( AttributeOptions ) | ( UiAttributeTypeBoolean ) | ( UiAttributeTypeMultiSelect ) | ( UiAttributeTypeSelect );
  CartAddressInterface: ( BillingCartAddress ) | ( ShippingCartAddress );
  CartItemInterface: ( BundleCartItem ) | ( ConfigurableCartItem ) | ( DownloadableCartItem ) | ( GiftCardCartItem ) | ( SimpleCartItem ) | ( VirtualCartItem );
  CategoryInterface: ( CategoryTree );
  CreditMemoItemInterface: ( BundleCreditMemoItem ) | ( CreditMemoItem ) | ( DownloadableCreditMemoItem ) | ( GiftCardCreditMemoItem );
  ...
  CustomizableProductInterface: ( BundleProduct ) | ( ConfigurableProduct ) | ( DownloadableProduct ) | ( GiftCardProduct ) | ( SimpleProduct ) | ( VirtualProduct );
  ErrorInterface: ( InternalError ) | ( NoSuchEntityUidError );
  GiftRegistryDynamicAttributeInterface: ( GiftRegistryDynamicAttribute ) | ( GiftRegistryRegistrantDynamicAttribute );
  GiftRegistryDynamicAttributeMetadataInterface: ( GiftRegistryDynamicAttributeMetadata );
  GiftRegistryItemInterface: ( GiftRegistryItem );
  GiftRegistryItemUserErrorInterface: ( GiftRegistryItemUserErrors ) | ( MoveCartItemsToGiftRegistryOutput );
  GiftRegistryOutputInterface: ( GiftRegistryOutput ) | ( MoveCartItemsToGiftRegistryOutput );
  InvoiceItemInterface: ( BundleInvoiceItem ) | ( DownloadableInvoiceItem ) | ( GiftCardInvoiceItem ) | ( InvoiceItem );
  LayerFilterItemInterface: ( LayerFilterItem ) | ( SwatchLayerFilterItem );
  MediaGalleryInterface: ( ProductImage ) | ( ProductVideo );
  OrderItemInterface: ( BundleOrderItem ) | ( DownloadableOrderItem ) | ( GiftCardOrderItem ) | ( OrderItem );
  PhysicalProductInterface: ( BundleProduct ) | ( ConfigurableProduct ) | ( GiftCardProduct ) | ( GroupedProduct ) | ( SimpleProduct );
  ProductInterface: ( BundleProduct ) | ( ConfigurableProduct ) | ( DownloadableProduct ) | ( GiftCardProduct ) | ( GroupedProduct ) | ( SimpleProduct ) | ( VirtualProduct );
  ProductLinksInterface: ( ProductLinks );
  RoutableInterface: ( BundleProduct ) | ( CategoryTree ) | ( CmsPage ) | ( ConfigurableProduct ) | ( DownloadableProduct ) | ( GiftCardProduct ) | ( GroupedProduct ) | ( SimpleProduct ) | ( VirtualProduct );
  SelectableInputTypeInterface: ( UiAttributeTypeBoolean ) | ( UiAttributeTypeMultiSelect ) | ( UiAttributeTypeSelect );
  ShipmentItemInterface: ( BundleShipmentItem ) | ( GiftCardShipmentItem ) | ( ShipmentItem );
  SwatchDataInterface: ( ColorSwatchData ) | ( ImageSwatchData ) | ( TextSwatchData );
  SwatchLayerFilterItemInterface: ( SwatchLayerFilterItem );
  UiInputTypeInterface: ( UiAttributeTypeAny ) | ( UiAttributeTypeBoolean ) | ( UiAttributeTypeFixedProductTax ) | ( UiAttributeTypeMultiSelect ) | ( UiAttributeTypePageBuilder ) | ( UiAttributeTypeSelect ) | ( UiAttributeTypeTextEditor ) | ( UiAttributeTypeTextarea );
  WishlistItemInterface: ( BundleWishlistItem ) | ( ConfigurableWishlistItem ) | ( DownloadableWishlistItem ) | ( GiftCardWishlistItem ) | ( GroupedProductWishlistItem ) | ( SimpleWishlistItem ) | ( VirtualWishlistItem );
};
...
export type ResolversTypes = {
  ...
  AttributeMetadataInterface: ResolverTypeWrapper<ResolversInterfaceTypes<ResolversTypes>['AttributeMetadataInterface']>;
  AttributeOption: ResolverTypeWrapper<AttributeOption>;
  AttributeOptionInterface: ResolverTypeWrapper<ResolversInterfaceTypes<ResolversTypes>['AttributeOptionInterface']>;
  AttributeOptions: ResolverTypeWrapper<AttributeOptions>;
  AttributeOptionsInterface: ResolverTypeWrapper<ResolversInterfaceTypes<ResolversTypes>['AttributeOptionsInterface']>;
  ...
  ByLocation: ResolverTypeWrapper<ByLocation>;
  ...
  GiftRegistryDynamicAttributeInterface: ResolverTypeWrapper<ResolversInterfaceTypes<ResolversTypes>['GiftRegistryDynamicAttributeInterface']>;
  GiftRegistryDynamicAttributeMetadata: ResolverTypeWrapper<GiftRegistryDynamicAttributeMetadata>;
  GiftRegistryDynamicAttributeMetadataInterface: ResolverTypeWrapper<ResolversInterfaceTypes<ResolversTypes>['GiftRegistryDynamicAttributeMetadataInterface']>;
  GiftRegistryItem: ResolverTypeWrapper<GiftRegistryItem>;
  GiftRegistryItemInterface: ResolverTypeWrapper<ResolversInterfaceTypes<ResolversTypes>['GiftRegistryItemInterface']>;
  GiftRegistryItemUserErrorInterface: ResolverTypeWrapper<ResolversInterfaceTypes<ResolversTypes>['GiftRegistryItemUserErrorInterface']>;
  ...
  GiftRegistryOutputInterface: ResolverTypeWrapper<ResolversInterfaceTypes<ResolversTypes>['GiftRegistryOutputInterface']>;
  ...
  SelectableInputTypeInterface: ResolverTypeWrapper<ResolversInterfaceTypes<ResolversTypes>['SelectableInputTypeInterface']>;
  ...
  UiInputTypeInterface: ResolverTypeWrapper<ResolversInterfaceTypes<ResolversTypes>['UiInputTypeInterface']>;
...
export type ResolversParentTypes = {
  ...
  Attribute: Attribute;
  AttributeInput: AttributeInput;
  AttributeMetadataInterface: ResolversInterfaceTypes<ResolversParentTypes>['AttributeMetadataInterface'];
  AttributeOption: AttributeOption;
  AttributeOptionInterface: ResolversInterfaceTypes<ResolversParentTypes>['AttributeOptionInterface'];
  AttributeOptions: AttributeOptions;
  AttributeOptionsInterface: ResolversInterfaceTypes<ResolversParentTypes>['AttributeOptionsInterface'];
  ...
  GiftRegistryDynamicAttributeInput: GiftRegistryDynamicAttributeInput;
  GiftRegistryDynamicAttributeInterface: ResolversInterfaceTypes<ResolversParentTypes>['GiftRegistryDynamicAttributeInterface'];
  GiftRegistryDynamicAttributeMetadata: GiftRegistryDynamicAttributeMetadata;
  GiftRegistryDynamicAttributeMetadataInterface: ResolversInterfaceTypes<ResolversParentTypes>['GiftRegistryDynamicAttributeMetadataInterface'];
  GiftRegistryItem: GiftRegistryItem;
  GiftRegistryItemInterface: ResolversInterfaceTypes<ResolversParentTypes>['GiftRegistryItemInterface'];
  GiftRegistryItemUserErrorInterface: ResolversInterfaceTypes<ResolversParentTypes>['GiftRegistryItemUserErrorInterface'];
  ...
  GiftRegistryOutputInterface: ResolversInterfaceTypes<ResolversParentTypes>['GiftRegistryOutputInterface'];
  ...
  SelectableInputTypeInterface: ResolversInterfaceTypes<ResolversParentTypes>['SelectableInputTypeInterface'];
  ...
  UiInputTypeInterface: ResolversInterfaceTypes<ResolversParentTypes>['UiInputTypeInterface'];
  UpdateCartItemsInput: UpdateCartItemsInput;
...
export type ByLocationResolvers<ContextType = GraphQLModules.ModuleContext, ParentType extends ResolversParentTypes['ByLocation'] = ResolversParentTypes['ByLocation']> = {
  availableToSell?: Resolver<Maybe<ResolversTypes['Int']>, ParentType, ContextType>;
  isInStock?: Resolver<Maybe<ResolversTypes['Boolean']>, ParentType, ContextType>;
  locationEntityCode?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  locationEntityId?: Resolver<Maybe<ResolversTypes['Int']>, ParentType, ContextType>;
  locationEntityTypeId?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  warningLevel?: Resolver<Maybe<ResolversTypes['Int']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
...
export type CustomerResolvers<ContextType = GraphQLModules.ModuleContext, ParentType extends ResolversParentTypes['Customer'] = ResolversParentTypes['Customer']> = {
  ...
  allow_remote_shopping_assistance?: Resolver<Maybe<ResolversTypes['Boolean']>, ParentType, ContextType>;
  compare_list?: Resolver<Maybe<ResolversTypes['CompareList']>, ParentType, ContextType>;
  created_at?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
...
export type MutationResolvers<ContextType = GraphQLModules.ModuleContext, ParentType extends ResolversParentTypes['Mutation'] = ResolversParentTypes['Mutation']> = {
  ...
  resetPassword?: Resolver<Maybe<ResolversTypes['Boolean']>, ParentType, ContextType, RequireFields<MutationResetPasswordArgs, 'code' | 'email' | 'newPassword' | 'resetPasswordToken'>>;
...
export type SimpleProductResolvers<ContextType = GraphQLModules.ModuleContext, ParentType extends ResolversParentTypes['SimpleProduct'] = ResolversParentTypes['SimpleProduct']> = {
  ...
  attribute_set_id?: Resolver<Maybe<ResolversTypes['Int']>, ParentType, ContextType>;
  availability?: Resolver<Maybe<ResolversTypes['ProductAvailability']>, ParentType, ContextType>;
  by_location?: Resolver<Maybe<Array<Maybe<ResolversTypes['ByLocation']>>>, ParentType, ContextType>;
  canonical_url?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  categories?: Resolver<Maybe<Array<Maybe<ResolversTypes['CategoryInterface']>>>, ParentType, ContextType>;
  category_gear?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  climate?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
...
export type StoreConfigResolvers<ContextType = GraphQLModules.ModuleContext, ParentType extends ResolversParentTypes['StoreConfig'] = ResolversParentTypes['StoreConfig']> = {
  ...
  paymentMethods?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
...
export type Resolvers<ContextType = GraphQLModules.ModuleContext> = {
  ...
  ByLocation?: ByLocationResolvers<ContextType>;
