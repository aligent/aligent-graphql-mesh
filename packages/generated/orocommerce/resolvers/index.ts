...
export type CustomerResolvers<ContextType = GraphQLModules.ModuleContext, ParentType extends ResolversParentTypes['Customer'] = ResolversParentTypes['Customer']> = {
  ...
  reviews?: Resolver<Maybe<ResolversTypes['ProductReviews']>, ParentType, ContextType, RequireFields<CustomerReviewsArgs, 'currentPage' | 'pageSize'>>;
  ...
  wishlists?: Resolver<Maybe<Array<Maybe<ResolversTypes['Wishlist']>>>, ParentType, ContextType, RequireFields<CustomerWishlistsArgs, 'currentPage' | 'pageSize'>>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
